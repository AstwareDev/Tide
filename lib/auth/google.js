...
export const GMAIL_SCOPES = [
  ...
  // Contacts scopes only cover OTHER people — Google doesn't let you be your
  // own contact — so the signed-in account's own avatar needs the userinfo
  // endpoint instead, which this scope gates.
